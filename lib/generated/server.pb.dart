...
class Object extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Object')
    ..e<ObjectType>(1, 'type', $pb.PbFieldType.OE, ObjectType.COMPUTER,
        ObjectType.valueOf, ObjectType.values)
    ..a<$core.int>(2, 'id', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false;

  Object() : super();
  Object.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  Object.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class StatusRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StatusRequest')
    ..a<Object>(
        1, 'target', $pb.PbFieldType.OM, Object.getDefault, Object.create)
    ..hasRequiredFields = false;

  StatusRequest() : super();
  StatusRequest.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  StatusRequest.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class StatusReply extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StatusReply')
    ..e<Status>(1, 'status', $pb.PbFieldType.OE, Status.UNKNOWN, Status.valueOf,
        Status.values)
    ..hasRequiredFields = false;

  StatusReply() : super();
  StatusReply.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  StatusReply.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class ToggleRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ToggleRequest')
    ..a<Object>(
        1, 'object', $pb.PbFieldType.OM, Object.getDefault, Object.create)
    ..hasRequiredFields = false;

  ToggleRequest() : super();
  ToggleRequest.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ToggleRequest.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static $pb.PbList<ToggleRequest> createRepeated() =>
      $pb.PbList<ToggleRequest>();
...
class ToggleReply extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ToggleReply')
    ..e<Status>(1, 'newStatus', $pb.PbFieldType.OE, Status.UNKNOWN,
        Status.valueOf, Status.values)
    ..hasRequiredFields = false;

  ToggleReply() : super();
  ToggleReply.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ToggleReply.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ToggleReply clone() => ToggleReply()..mergeFromMessage(this);
  ToggleReply copyWith(void Function(ToggleReply) updates) =>
      super.copyWith((message) => updates(message as ToggleReply));
  $pb.BuilderInfo get info_ => _i;
...
class PowerOnRequest extends $pb.GeneratedMessage {
  ...
  PowerOnRequest.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  PowerOnRequest.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  PowerOnRequest clone() => PowerOnRequest()..mergeFromMessage(this);
  PowerOnRequest copyWith(void Function(PowerOnRequest) updates) =>
      super.copyWith((message) => updates(message as PowerOnRequest));
  $pb.BuilderInfo get info_ => _i;
  static PowerOnRequest create() => PowerOnRequest();
  PowerOnRequest createEmptyInstance() => create();
  static $pb.PbList<PowerOnRequest> createRepeated() =>
      $pb.PbList<PowerOnRequest>();
...
class PowerOnReply extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PowerOnReply')
    ..e<Status>(1, 'previousStatus', $pb.PbFieldType.OE, Status.UNKNOWN,
        Status.valueOf, Status.values)
    ..hasRequiredFields = false;

  PowerOnReply() : super();
  PowerOnReply.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  PowerOnReply.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  PowerOnReply clone() => PowerOnReply()..mergeFromMessage(this);
  PowerOnReply copyWith(void Function(PowerOnReply) updates) =>
      super.copyWith((message) => updates(message as PowerOnReply));
  $pb.BuilderInfo get info_ => _i;
  static PowerOnReply create() => PowerOnReply();
  PowerOnReply createEmptyInstance() => create();
  static $pb.PbList<PowerOnReply> createRepeated() =>
      $pb.PbList<PowerOnReply>();
